local function snap_create()
   ...
   -- merge custom config and override table values
   override_config = vim.tbl_deep_extend("force", git.current_config, override_config)

   local auto_generated_disclaimer = '---- Auto-generated by NvChadSnapshotCreate ----'

   -- add the override table to chadrc.lua
   utils.write_data('return M', auto_generated_disclaimer .. '\n\n' ..
      (type(git.current_config.plugins) == 'table' and '' or 'M.plugins = {}\n\n') ..
      'M.plugins.override = {\n' .. misc.table_to_string(override_config.plugins.override) ..
      '}\n\n' .. misc.print_padding('-', string.len(auto_generated_disclaimer), true) ..
      '\n\nreturn M')
