...
M.already_on_selected_snapshot_branch = { { "You are already on the selected snapshot branch (", "Title" }, { "<SNAP_NAME>" }, { ").", "Title" } }
M.already_on_selected_update_branch = { { "You are already on the selected update branch (", "Title" }, { "<SNAP_NAME>" }, { ").", "Title" } }
...
M.no_snapshots_found = { { "No snapshots found! Use ", "WarningMsg" }, { "NvChadSnapshotCreate" }, { " to create your first snapshot.", "WarningMsg" } }
...
M.stashing_custom_dir = { { "Stashing custom directory under: ", "WarningMsg" }, { "<STASH_NAME>" }, { ".", "WarningMsg" } }
